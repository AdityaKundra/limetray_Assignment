...
const TaskInput = () => {
  ...
  return (
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row items-center justify-center">
            <input type='text' className='p-4 mb-2 md:m-4 border-2 text-black outline-0 font-xl font-bold md:rounded-xl md:rounded-r-none md:mr-1 w-full md:w-auto dark:bg-neutral-800 dark:text-white' value={task} placeholder='Add a New Task !' onChange={(e)=>setTask(e.target.value)}/>
